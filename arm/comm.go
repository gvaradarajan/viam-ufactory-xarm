...
func insertFloat(params []byte, num float64) []byte {
...
func (x *xArm) MoveToPosition(ctx context.Context, pos spatialmath.Pose, extra map[string]interface{}) error {
	...
	c1.params = insertFloat(c1.params, point.X)
	c1.params = insertFloat(c1.params, point.Y)
	c1.params = insertFloat(c1.params, point.Z)
	c1.params = insertFloat(c1.params, angles.RX*angles.Theta)
	c1.params = insertFloat(c1.params, angles.RY*angles.Theta)
	c1.params = insertFloat(c1.params, angles.RZ*angles.Theta)
	c1.params = insertFloat(c1.params, defaultSpeed) // speed mm/s
	c1.params = insertFloat(c1.params, defaultAccel) // acceleration mm/s
	c1.params = insertFloat(c1.params, 0.0)          // motion time
